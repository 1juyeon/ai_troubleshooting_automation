    ...
    def save_analysis(self, analysis_result: Dict, inquiry_data: Dict):
        ...
        try:
            ...
            new_entry = {
                ...
                'response_type': analysis_result.get('gemini_result', {}).get('parsed_response', {}).get('response_type', '') or analysis_result.get('gpt_result', {}).get('parsed_response', {}).get('response_type', ''),
                'summary': analysis_result.get('gemini_result', {}).get('parsed_response', {}).get('summary', '') or analysis_result.get('gpt_result', {}).get('parsed_response', {}).get('summary', ''),
                'action_flow': analysis_result.get('gemini_result', {}).get('parsed_response', {}).get('action_flow', '') or analysis_result.get('gpt_result', {}).get('parsed_response', {}).get('action_flow', ''),
                'email_draft': analysis_result.get('gemini_result', {}).get('parsed_response', {}).get('email_draft', '') or analysis_result.get('gpt_result', {}).get('parsed_response', {}).get('email_draft', ''),
